...
public class EnderRenderer {
	...
	public static void tick() {
		...
		EnderPackagerBehaviour behaviour = BlockEntityBehaviour.get(world, pos, EnderPackagerBehaviour.TYPE);
		if (behaviour == null)
			return;
	...
	public static void renderOnBlockEntity(SmartBlockEntity be, float partialTicks, PoseStack ms,
		...
		EnderPackagerBehaviour behaviour = be.getBehaviour(EnderPackagerBehaviour.TYPE);
		if (behaviour == null)
			return;
		for (boolean first : Iterate.trueAndFalse) {
