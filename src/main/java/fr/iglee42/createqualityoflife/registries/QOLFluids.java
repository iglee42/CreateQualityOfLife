...
public class QOLFluids {
    public static final FluidEntry<BaseFlowingFluid.Flowing> SUPERHEATED_LAVA =
            REGISTRATE.standardFluid("superheated_lava",
                    ...
                    .properties(b -> b.viscosity(6200)
                            ...
                            .adjacentPathType((PathType)null)
                    ...
                    .defaultModel()
                    .tag(Tags.Items.BUCKETS, QOLTags.QOLItemTags.SUPERHEATED_LAVA_BUCKETS.tag)
                    .build()
                    .register();
