...
import static fr.iglee42.createqualityoflife.registries.QOLTags.NameSpace.FORGE;
...
public class QOLTags {
	...
	public enum QOLItemTags {
        SUPERHEATED_LAVA_BUCKETS(FORGE, "buckets/superheated_lava")
