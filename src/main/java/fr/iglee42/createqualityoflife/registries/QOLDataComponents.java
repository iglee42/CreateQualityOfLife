...
public class QOLDataComponents {
    ...
    public static final DataComponentType<Boolean> INVISIBLE_ARMOR = register("invisible_armor",b->b.persistent(Codec.BOOL).networkSynchronized(ByteBufCodecs.BOOL));
