...
public class ShadowRadianceSword extends SwordItem implements QOLConfigurableItem {
    public ShadowRadianceSword(Properties p_42964_) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable TooltipContext p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(Component.translatable("createqol.ability.tool.toggle_message", Component.translatable("createqol.ability.tool.repulsion_attraction").getString())
                .withStyle(ChatFormatting.GOLD)
    ...
    public void addConfigurations(List<Configuration<?>> list, ItemStack stack) {
        list.add(Configuration.ofBool("Reach",stack.getOrDefault(QOLDataComponents.REACH,true),QOLDataComponents.REACH,
                List.of("Should extend the reach of the sword"),(e,oe)->CreateQOLConfigs.server().equipments.tools.reach.get()));
    }
