...
public class ShadowRadianceChestplate extends BacktankItem.Layered{
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> components, TooltipFlag p_41424_) {
        ...
        components.add(new TextComponent("Propeller : ").withStyle(ChatFormatting.GOLD).append(new TextComponent(hasPropeller(stack) ? "installed" : "not installed").withStyle(ChatFormatting.YELLOW)));
        if (hasPropeller(stack)) {
            components.add(new TextComponent(""));
            components.add(new TextComponent("Fans : ").withStyle(ChatFormatting.GOLD).append(new TextComponent(String.valueOf(isFansEnable(stack))).withStyle(ChatFormatting.YELLOW)));
            components.add(new TextComponent("Hover : ").withStyle(ChatFormatting.GOLD).append(new TextComponent(String.valueOf(isHoverEnable(stack))).withStyle(ChatFormatting.YELLOW)));
        }
    ...
    public static void toggleFans(ItemStack chestplate,Player p) {
        ...
        p.displayClientMessage(new TextComponent("Fans : ").append(new TextComponent(String.valueOf(fans)).withStyle(fans ? ChatFormatting.GREEN : ChatFormatting.RED)),true);
    }
    public static void toggleHover(ItemStack chestplate,Player p) {
        ...
        p.displayClientMessage(new TextComponent("Hover : ").append(new TextComponent(String.valueOf(hover)).withStyle(hover ? ChatFormatting.GREEN : ChatFormatting.RED)),true);
    }
