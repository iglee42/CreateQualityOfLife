...
public class ItemHandlerSingleBeltSegment implements IItemHandler {

	private final SingleBeltInventory beltInventory;
	int offset;

	public ItemHandlerSingleBeltSegment(SingleBeltInventory beltInventory, int offset) {
